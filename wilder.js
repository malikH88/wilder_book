window.addEventListener("DOMContentLoaded", (event) => {
    ...
    {name:'Angélique <br> Mora <a href="https://www.linkedin.com/in/angeliquemora/"><i class="fab fa-linkedin"></i></a>',image : 'image/angelique.png', mobility:'<li>Mobilité : Internationale <li>Domaine : Web, Jeux-vidéos'}, 
